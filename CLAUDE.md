...
Adota.THE is a pet-adoption platform (pt-BR) being built as a React + Vite + Tailwind CSS frontend backed by Firebase (Auth, Firestore) and Cloudinary (pet photo storage), deployed to GitHub Pages from a **public** repository.
